...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("pl.edu.bikerental.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("pl.edu.bikerental.security.DomainUserDetailsService", "createSpringSecurityUser");
