...
import { CustomerProfileDeleteDialog } from './customer-profile-delete-dialog';

describe('CustomerProfile Management Delete Component', () => {
  let comp: CustomerProfileDeleteDialog;
  let fixture: ComponentFixture<CustomerProfileDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CustomerProfileDeleteDialog);
