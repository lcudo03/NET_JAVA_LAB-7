...
import pl.edu.bikerental.config.Constants;
import pl.edu.bikerental.domain.User;
import pl.edu.bikerental.repository.UserRepository;
import pl.edu.bikerental.security.AuthoritiesConstants;
import pl.edu.bikerental.service.MailService;
import pl.edu.bikerental.service.UserService;
import pl.edu.bikerental.service.dto.AdminUserDTO;
import pl.edu.bikerental.web.rest.errors.BadRequestAlertException;
import pl.edu.bikerental.web.rest.errors.EmailAlreadyUsedException;
import pl.edu.bikerental.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link pl.edu.bikerental.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
